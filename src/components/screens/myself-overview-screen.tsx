...
export function MyselfOverviewScreen() {
  ...
  return (
    <div className="grid gap-6">
      <PageTitle eyebrow="Personal overview" title="Myself" subtitle="Private income and expenses that do not belong to any group." action={<Link href="/expenses/new?personal=1" className="grid size-11 place-items-center rounded-xl bg-brand text-brand-ink" aria-label="Add personal record"><Plus size={20} /></Link>} />
